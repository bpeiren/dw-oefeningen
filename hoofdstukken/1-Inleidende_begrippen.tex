...
\begin{enumerate}
  ...
  \item Toon aan dat
    \begin{itemize}
      \item \(B \supset A \Leftrightarrow A \cup B = B \Leftrightarrow A \cap B = A\)
      \item \(A \cup (A \cap B) = A\)
      \item \(A \cap (A \cup B) = A\)
    \end{itemize}
    Ik snap deze drie stellingen, maar hoe bewijs je ze effectief? Ik zou daar tekeningen voor maken,
    maar dat lijkt mij niet de bedoeling.
